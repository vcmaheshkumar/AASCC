                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <form action="" class="form-sample" method="post">
                                            <input type="text" name="userName" value="<?php echo $_SESSION['user_name'] ?>" hidden />
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">From</label>
                                                <input type="text" class="form-control text-muted" name="userFrom" value="<?php echo $_SESSION['type'] ?>" readonly required />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Message</label>
                                                <input type="text" class="form-control" id="exampleInputName1" name="userMessage" placeholder="Type your Message" required />
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">To</label>
                                                <select class="form-control form-control-sm" id="exampleFormControlSelect1" name="userTo" required>
                                        ...
                                        <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                while($msgRow = $msgQuery->fetch_assoc()){
                                                    if($msgRow['msgname'] == $_SESSION['user_name']){
                                                ?>
                                                <tr>
