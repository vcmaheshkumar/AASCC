<?php
define('admin',true);
$title = "ADMINISTRATION | UPDATE | EVENTS";
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-title d-flex justify-content-between align-items-center m-4">
                            ...
                            <a class="btn btn-outline-success mb-2" href="http://localhost/projectApollo/admin/update/events">Go back</a>
                        </div>
                        <div class="card-body">
                            <form class="forms-sample" method="POST">
                                ...
                                <input type="hidden" name="eventid" value="<?php echo $row['id'] ?>" hidden>
                                ...
                                <button type="submit" class="btn btn-primary me-2" name="updateEvent">Update</button>
                            </form>
                        </div>
                    </div>
                </div>
