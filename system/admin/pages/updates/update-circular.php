<?php
define('admin',true);
$title = "ADMINISTRATION | UPDATE | CIRCULAR";
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-title d-flex justify-content-between align-items-center m-4">
                            <h4 class="card-title">Update Circular</h4>
                        ...
                        <div class="card-body">
                            <form class="forms-sample" method="POST">
                                ...
                                <input type="hidden" name="circularid" value="<?php echo $row['id'] ?>" hidden>
                                ...
                                <button type="submit" class="btn btn-primary me-2" name="updateCircular">Update</button>
                            </form>
                        </div>
                    </div>
                </div>
